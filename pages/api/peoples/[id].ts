...
import deleteService from "../../../services/api/modules/people/delete";
import getOne from "../../../services/api/modules/people/getOne";
import update from "../../../services/api/modules/people/update";

export default async function handlePeople(
  req: NextApiRequest,
  res: NextApiResponse
) {
  const {
