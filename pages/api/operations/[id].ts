...
import deleteService from "../../../services/api/modules/operation/delete";
import getOne from "../../../services/api/modules/operation/getOne";
import update from "../../../services/api/modules/operation/update";

export default async function handleOperations(
  req: NextApiRequest,
  res: NextApiResponse
) {
  const {
