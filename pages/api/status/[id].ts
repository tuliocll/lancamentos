...
import deleteService from "../../../services/api/modules/status/delete";
import getOne from "../../../services/api/modules/status/getOne";
import update from "../../../services/api/modules/status/update";
